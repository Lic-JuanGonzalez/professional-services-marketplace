package com.marketplace.professional.config;

import com.marketplace.professional.security.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/services/**").hasAnyRole("PROFESSIONAL", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/reviews/**").permitAll()
                        .requestMatchers("/reviews/**").hasAnyRole("CLIENT", "ADMIN")
                        .requestMatchers("/hires/**").hasAnyRole("CLIENT", "PROFESSIONAL", "ADMIN")
